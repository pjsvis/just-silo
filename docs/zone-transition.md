...
┌─────────────────────────────────────────────────────────────────┐
│                                                                 │
│   HERE (Slow Zone)              THERE (Beyond)                  │
│   ───────────────              ───────────────                  │
│                                                                 │
│   "That stuff doesn't          "That stuff starts to             │
│    really work here."          impinge on us a tad more."       │
│                                                                 │
│   Current capabilities:        Future capabilities:             │
│   - Primitive agents           - Advanced agents                 │
│   - Simple silos               - Coordinating silos             │
│   - Easy containment           - Containment matters             │
│   - Low risk                  - Higher risk                     │
│                                                                 │
│   Risk is theoretical.         Risk is practical.               │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
...
SLOW ZONE ──────────────────────────────────────────────────────► BEYOND
   ...
   │   Practice CAW-Canny."                   We need to be          │
   │                                          aware."              │
   │                                                                │
◄──┼──►  We are here.                                               │
│   │                                                                │
...
┌─────────────────────────────────────────────────────────────────┐
│                                                                 │
│   CAPABILITIES EMERGE ───────────► ZONE TRANSITION              │
│                                                                 │
│   "When the silo can do X, then we need Y."                     │
│                                                                 │
│   Don't prepare for Beyond until Beyond is approaching.          │
│   But don't wait until you're there to start preparing.         │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
...
│   ─────────────────────     ─────────────────────                │
│                                                                 │
│   Level 1                 Level 0 containment                   │
│                                                                 │
│   Level 2                 Level 1 containment                   │
│                                                                 │
│   Level 3                 Level 2 containment                   │
│                                                                 │
│   Level N                 Level N-1 containment                  │
│                                                                 │
...
│   TRAIN LIKE YOU PLAY                                           │
│                                                                 │
│   Slow Zone training:              Beyond execution:             │
│   - Blast radius = 1              - Blast radius = 1           │
│   - CAW-Canny monitoring          - CAW-Canny monitoring        │
│   - Orchestrator watching         - Orchestrator watching       │
│   - Review is not a pass          - Review is not a pass       │
│                                                                 │
...
│                                                                 │
│   1. ANNOUNCE                                                    │
│      "We're moving silo X to Level 2."                          │
│                                                                 │
│   2. PREPARE                                                     │
│      Tighten monitoring. Brief orchestrator.                     │
│      Ready CTX for closer attention.                             │
│                                                                 │
│   3. TRANSITION                                                  │
│      Adjust blast radius. Update manifest.                       │
│                                                                 │
│   4. MONITOR INTENSIVELY                                        │
│      Watch all key factors. CAW-Canny maximum.                  │
│                                                                 │
│   5. REVIEW EARLY AND OFTEN                                     │
│      First review after 24 hours. Then weekly.                   │
│      Look for surprises.                                         │
│                                                                 │
│   6. REVERT IF NEEDED                                           │
│      "This is harder than we thought."                         │
│      Pull back. Recalibrate. Try again when ready.              │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
