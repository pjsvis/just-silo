...
| Field      | Value                                           |
| ---------- | ----------------------------------------------- |
| Identifier | `claude-office-skills-skills-infographic`                                |
| Version    | 1.0.0                                     |
...
**GitHub:** [claude-office-skills/skills](https://github.com/claude-office-skills/skills) — ⭐ 7 | Forks: 6
...
This Skill helps plan and specify infographics by producing clear layout wireframes, structured content sections, and visual hierarchies that communicate data-driven stories. Key features include recommended infographic types (statistical, timeline, process, comparison, geographic, hierarchical, list), layout blueprints, prioritized copy and text hierarchy, chart and icon recommendations, color palette and typography guidance, and exact size and export-ready spec details designers can implement. Use cases include marketing assets for social media, lead-generation landing pages, printed reports, investor decks, and educational materials. Core advantages are faster design handoffs, consistent visual messaging, improved data clarity, and fewer iteration cycles: you receive designer-ready specifications rather than final graphics, enabling designers to produce production assets efficiently.
...
```bash
npx -y @lobehub/market-cli skills install claude-office-skills-skills-infographic
```
...
npx -y @lobehub/market-cli skills install claude-office-skills-skills-infographic --agent open-claw

# Claude Code (installs to ./.claude/skills/)
npx -y @lobehub/market-cli skills install claude-office-skills-skills-infographic --agent claude-code

# Codex (installs to ./.agents/skills/)
npx -y @lobehub/market-cli skills install claude-office-skills-skills-infographic --agent codex

# Cursor (installs to ./.cursor/skills/)
npx -y @lobehub/market-cli skills install claude-office-skills-skills-infographic --agent cursor
```

Install a specific version:

```bash
npx -y @lobehub/market-cli skills install claude-office-skills-skills-infographic --version 1.0.0
```
...
```bash
npx -y @lobehub/market-cli skills rate claude-office-skills-skills-infographic --score <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills comment claude-office-skills-skills-infographic -c "Your feedback here" --rating <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills uncomment claude-office-skills-skills-infographic
```
...
```bash
npx -y @lobehub/market-cli skills comments claude-office-skills-skills-infographic
```
